                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">
                            {{$update_mode ? 'Update' : 'Tambah'}} schedules</h5>
                    </div>
                    <div class="modal-body">
                        <x-select name="schedule_status" label="Status">
                        ...
                        <x-text-field type="text" name="schedule_link_meet" label="Link meet" />
                        @endif
                        @if ($schedule_status == 2)
                        <x-textarea type="textarea" name="schedule_note" label="Note" />
                        @endif
