                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>plans</span>
                        </a>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">
                            {{$update_mode ? 'Update' : 'Tambah'}} plans</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="plan_title" label="Nama Plan" />
                        <x-text-field type="number" name="plan_price" label="Harga Plan" />
                        <x-text-field type="number" name="plan_duration" label="Durasi Plan(hari)" />
                        <x-text-field type="number" name="plan_max_mentor" label="Max Mentor Type" />
                        <x-select name="plan_max_type" label="Max Mentor Type">
                            <option value="">Select Max Mentor Type</option>
