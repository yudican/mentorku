<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3"></i>active plans</span>
                        </a>
                    </h4>
                </div>
            </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="date" name="plan_start_date" label="Start date" />
                    <x-text-field type="date" name="plan_end_date" label="End Date" />
                    <x-text-field type="text" name="plan_status" label="Status" />
            ...
            @else
            <livewire:table.active-plan-table />
            @endif
