...
class ChatDetail extends Component
{
    ...
    public function send()
    {
        ...
        $sender_id = $role == 'mentor' ? $this->chat->mentor_id : $this->chat->user_id;
        $receiver_id = $role == 'mentor' ? $this->chat->user_id : $this->chat->mentor_id;
        ...
        if ($parent) {
            if ($role == 'member') {
                ...
                if ($parent->sender_id == $this->chat->mentor_id) {
                    if (!$parent->parent_id) {
                        $parent_id = $parent->id;
                    } else {
                        $parent_id = $parent->parent_id;
